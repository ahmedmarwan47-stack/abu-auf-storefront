...
TPL = {
    ...
    "لديك {0} نقطة في محفظتك{1}ويمكنك خصم {2}":
        "You have {0} points in your wallet{1}and can redeem {2}",
    "استخدمت {0} نقطة من محفظتك": "You used {0} points from your wallet",
...
CHROME = {
    ...
    "تم إلغاء خصم النقاط": "Points discount removed",
    "تم خصم": "Discounted",
