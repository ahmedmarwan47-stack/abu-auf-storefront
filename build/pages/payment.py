...
site already ships and displays in its own footer — `images/abuauf/payments/`
...
def _marks(*files):
    ...
    return (
        ...
        + "".join(
            f'<img src="images/abuauf/payments/{f}" alt="" '
      ...
      <section class="py-8">
        <div class="items-start gap-10 grid grid-cols-1 lg:grid-cols-[1fr_380px] mx-auto px-4 max-w-[1100px]">
          ...
          <div class="flex flex-col gap-3 order-1 lg:order-none lg:col-span-2 min-w-0">
            <h1 class="font-bold text-[#062A1C] text-2xl xl:text-3xl">طريقة الدفع</h1>
...
{checkout_summary(summary_lines, subtotal, total, DELIVERY_FEE, interactive=False)}
    ...
    return page("طريقة الدفع | أبو عوف",
                "اختر طريقة الدفع وأكد طلبك من أبو عوف.",
