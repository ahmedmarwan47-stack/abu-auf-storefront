...
def build():
    ...
    body = f"""{page_header("", [("الرئيسية", "index.html"), ("البلوج", "blogs.html"), (heading, None)])}
      ...
      <article class="py-6">
        <div class="flex flex-col gap-6 mx-auto px-4 xl:px-[190px] max-w-[900px]">
          ...
          <h1 class="font-bold text-[#062A1C] text-3xl xl:text-4xl leading-tight">{e(heading)}</h1>
          ...
          <div class="flex flex-col gap-3 bg-interaction-base p-6 rounded-2xl">
            <h2 class="font-bold text-[#062A1C] text-lg">نصائح سريعة</h2>
    ...
    return page(f"{heading} | أبو عوف", excerpt, body, "blog", "/blog")
