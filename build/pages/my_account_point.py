...
def build():
    ...
    earn = "".join(f"""
                <div class="flex flex-col gap-1 bg-white shadow-custom4 p-4 rounded-2xl">
                  ...
                  <span class="mt-1 font-bold text-[#062A1C] text-sm">{title}</span>
    ...
    content = f"""
            ...
            <div data-points data-points-base="{pts}" class="flex flex-col gap-5 bg-primary shadow-custom4 p-6 xl:p-7 rounded-[20px] text-white">
              <div class="flex items-center gap-4">
                <img src="images/abuauf/icons/points-3d.png" alt="" class="w-16 h-16 object-contain shrink-0" />
            ...
            <div class="flex flex-col gap-3">
              <h2 class="font-bold text-[#062A1C] text-lg">مستويات العضوية</h2>
