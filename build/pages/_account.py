...
NAV_ICON_3D = {
    "my-account.html": "images/abuauf/icons/home-3d.png",
    "my-account-orders.html": "images/abuauf/icons/orders-3d.png",
    "my-account-favorites.html": "images/abuauf/icons/favorites-3d.png",
    "my-account-addresses.html": "images/abuauf/icons/addresses-3d.png",
    "my-account-wallet.html": "images/abuauf/icons/wallet-3d.png",
    "my-account-vouchers.html": "images/abuauf/icons/voucher-3d.png",
    "my-account-point.html": "images/abuauf/icons/points-3d.png",
    "my-account-profile.html": "images/abuauf/icons/profile-3d.png",
}
...
def account_title(active_slug, title):
    ...
    return (f'<div class="flex items-center gap-3">{icon}'
            f'<h1 class="font-bold text-[#062A1C] text-2xl xl:text-3xl">{e(title)}</h1></div>')
...
def _nav_badge(href):
    ...
    pill = ('inline-flex items-center justify-center shrink-0 bg-[#E9F3E6] '
            'rounded-full px-2 min-w-[26px] h-6 font-bold text-[#163300] text-xs latin')
...
def sidebar(active_slug):
    ...
    return f"""
          <aside class="hidden lg:flex flex-col gap-1 bg-white shadow-custom4 p-5 rounded-[20px] lg:sticky lg:top-4 min-w-0 h-max">
            ...
            <button type="button" data-logout class="flex justify-center items-center gap-2 mt-4 py-3 border border-neutral-divider hover:border-cta rounded-full font-semibold text-[#062A1C] text-sm transition-colors">
...
_STEP_ART = [
    "images/abuauf/icons/track-placed-3d.png",
    "images/abuauf/icons/track-preparing-3d.png",
    "images/abuauf/icons/track-transit-3d.png",
    "images/abuauf/icons/track-delivered-3d.png",
]
